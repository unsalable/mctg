...
const DefaultHomeIcon = (props: React.SVGProps<SVGSVGElement>): React.ReactElement => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
const DefaultCompassIcon = (props: React.SVGProps<SVGSVGElement>): React.ReactElement => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
const DefaultBellIcon = (props: React.SVGProps<SVGSVGElement>): React.ReactElement => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
type LimelightNavProps = {
  ...
  /** Dışarıdan kontrol edilen etkin sekme; verilirse bileşen kendi durumunu takip etmez. */
  activeIndex?: number
...
export const LimelightNav = ({
  ...
  iconClassName
}: LimelightNavProps): React.ReactElement | null => {
  ...
  const handleItemClick = (index: number, itemOnClick?: () => void): void => {
